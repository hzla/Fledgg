...
(function() {
  ...
  Meeting = {
    ...
    initDateTimePicker: function() {
      return $('#meeting_start_time').datetimepicker({
        format: 'd.m.Y H:i',
        lang: 'en',
        minDate: 0,
        minTime: 0,
    ...
    thankUser: function() {
      return $('.message-body').html("<h1>Thank You for Rating!</h1>");
    },
    rate: function() {
      var rating;
      rating = $(this).attr('id');
...
(function() {
  ...
  Search = {
    ...
    showFollowed: function() {
      return $(this).find('div').text('FOLLOWED');
    },
    doNothing: function() {},
...
(function() {
  ...
  Status = {
    init: function() {
      ...
      this.scrollMeetings();
      return $('.like-link').on('ajax:success', this.like);
    },
