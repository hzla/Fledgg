...
(function() {
  ...
  Status = {
    init: function() {
      ...
      this.scrollMeetings();
      return $('.like').on('click', this.like);
    },
    ...
    like: function() {
      var newCount;
      newCount = parseInt($(this).next().text()) + 1;
      return $(this).next().text(newCount);
    },
    checkBody: function() {
      var body;
